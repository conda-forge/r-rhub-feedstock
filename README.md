...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-rhub-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9835&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-rhub-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-rhub` can be installed with:

```
conda install r-rhub
```

It is possible to list all of the versions of `r-rhub` available on your platform with:
